...
| Model multiple susceptible compartments with age-specific susceptibility | [examples/vaccinated_compartment_susceptibility.R](examples/vaccinated_compartment_susceptibility.R), [docs/generic_compartment_models.md](docs/generic_compartment_models.md) |
| Model age-specific infectiousness by compartment and age | [examples/generic_age_specific_infectiousness.R](examples/generic_age_specific_infectiousness.R), [docs/generic_compartment_models.md](docs/generic_compartment_models.md) |
